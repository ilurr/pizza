...
<template>
    <div class="relative p-4 md:p-0">
        ...
        <h3 class="text-surface-900 dark:text-surface-0 text-xl font-bold !mt-2 mb-4 text-left px-2">Welcome back, Chef! 👋</h3>
            ...
            <div class="flex flex-col gap-4 items-center">
                <div class="flex items-center gap-4 w-full">
                    <div class="flex items-center gap-4">
                        ...
                        <div>
                            <div class="font-medium text-xl text-gray-900 dark:text-white mb-1 truncate">{{ driverStore.driverProfile?.name }}</div>
                    ...
                    <div class="flex gap-3 ml-auto items-center">
                        ...
                        <div class="flex items-center gap-2">
                            ...
                            <Button :label="driverStore.isOnline ? 'ON' : 'OFF'" rounded :severity="driverStore.isOnline ? 'success' : 'danger'" @click="toggleOnlineStatus" :icon="driverStore.isOnline ? 'pi pi-face-smile' : 'pi pi-power-off'" />
                ...
                <div class="relative text-base/6 w-full pt-4 pb-2 border-t">Your coverage area: <br /><strong>Gayungan, Tambaksari, Gubeng, Wonorejo</strong></div>
            </div>
        </div>
        ...
        <div class="card w-full">
            ...
            <DataTable :value="[...driverStore.activeOrders, ...driverStore.pendingOrders].slice(0, 5)" responsiveLayout="scroll" :paginator="false">
                ...
                <Column header="Distance">
                    <template #body="{ data }"> {{ data.distance }}km </template>
                </Column>
            </DataTable>

            <div v-if="driverStore.pendingOrders.length === 0 && driverStore.activeOrders.length === 0" class="text-center py-6 text-600">
        ...
        <div class="card mb-4">
            ...
            <div class="text-center">
                ...
                <div class="text-sm text-600">Based on {{ driverStore.stats.totalDeliveries }} deliveries</div>
            </div>
        </div>
        ...
        <div class="card">
            ...
            <Button label="Update Location" icon="pi pi-refresh" @click="driverStore.updateLocation" :loading="driverStore.isUpdatingLocation" size="small" class="w-full" outlined />
        </div>
    </div>
</template>

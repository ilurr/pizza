...
<template>
    <div class="bg-white dark:bg-neutral-900">
        <div class="landing-wrapper overflow-hidden">
            <app-topbar variant="page-header" page-title="Notifications" :show-notification-actions="true" :notification-stats="notificationStats" @back="goBack" @mark-all-read="handleMarkAllRead" @clear-all="handleClearAll"></app-topbar>
                ...
                <div class="relative md:py-4">
                    ...
                    <div v-else-if="filteredNotifications.length === 0" class="text-center py-12">
                        ...
                        <p class="text-gray-500 dark:text-gray-500">
                            {{ selectedFilter !== 'all' || selectedStatus !== 'all' ? 'Try adjusting your filters' : 'Notifications will appear here when you have activity' }}
                        </p>
                    </div>
                    ...
                    <div v-else class="">
                        <div
                            ...
                            :key="notification.id"
                            :class="['bg-white dark:bg-neutral-800 p-4 md:p-6 transition-all border-b border-surface', !notification.read ? 'border-l-4 !border-l-blue-500' : '']"
                                ...
                                <div class="flex-1 min-w-0">
                                    <div class="flex items-start justify-between">
                                        ...
                                        <div class="flex items-center space-x-2 ml-4">
                                            ...
                                            <Button icon="pi pi-times" text size="small" severity="danger" @click.stop="deleteNotification(notification.id)" class="w-6 h-6" />
                                        </div>
                                    </div>
                                </div>
                            </div>

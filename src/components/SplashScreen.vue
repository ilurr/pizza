...
<template>
    <div v-if="isVisible" class="fixed inset-0 bg-papa-red flex items-center justify-center z-50 animate-fadeIn">
        <div class="text-center text-white animate-slideUp">
            <!-- Logo -->
            <div class="mb-8">
                <img :src="brand.logos.square" :alt="brand.name" class="w-64 h-64 mx-auto animate-bounce" />
            </div>
            ...
            <p class="text-lg md:text-xl mb-12 opacity-90 font-light">
                serving <em><b>quality pizza</b></em
                ><br />
            ...
            <!-- Spinner -->
            <div class="my-8">
                <div class="w-5 h-5 border-2 border-white/30 border-t-white rounded-full animate-spin mx-auto mb-4"></div>
